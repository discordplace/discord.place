...
export default function UserAvatar({ id, hash, format, size, className, motionOptions, alt = '', ...props }) {
  ...
  async function handleError() {
    if (currentSource === DEFAULT_AVATAR_BASE64) return;
