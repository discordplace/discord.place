        ...
        {content && (
          <RadixTooltip.Portal>
            <RadixTooltip.Content
              className='z-10000 max-w-[300px] rounded-lg bg-black px-3 py-1 text-center text-sm font-semibold text-white origin-(--radix-tooltip-content-transform-origin) dark:bg-white dark:text-black sm:max-w-[unset]'
