      ...
      >
        ...
        <AnimatePresence>
          {showCaptcha && (
            ...
            <motion.div animate={{ opacity: 1 }} className='cf-turnstile [&>iframe]:max-w-full' data-sitekey={process.env.NEXT_PUBLIC_CF_SITE_KEY} exit={{ opacity: 0 }} initial={{ opacity: 0 }} ref={captchaRef} />
          )}
        </AnimatePresence>
