...
export default function SearchInput() {
  ...
  function validateValue(throwError = true) {
    ...
    if (!value) return returnError('Please enter a valid search query to find emojis.');

    const trimmedValue = value.trim();
    if (trimmedValue.length <= 0) return returnError('Please enter a valid search query to find emojis.');
