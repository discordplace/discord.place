  ...
  return (
    <div className='flex w-full flex-1 justify-end'>
      <button
        ...
        disabled={loading}
        className='mt-4 flex w-full items-center justify-center gap-x-1.5 rounded-full bg-tertiary px-4 py-2 text-sm font-semibold text-secondary select-none hover:bg-quaternary hover:text-primary disabled:pointer-events-none disabled:opacity-70 mobile:mt-0 mobile:w-max mobile:rounded-lg mobile:py-1.5'
      >
