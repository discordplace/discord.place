...
export default function Bot({ avatar_base64, data }) {
  ...
  return (
    <div style={{ alignItems: 'center', display: 'flex', flexDirection: 'column', gap: '0px' }}>
      <div style={{ alignItems: 'center', display: 'flex', gap: '24px' }}>
        ...
        <div style={{ alignItems: 'center', display: 'flex', fontSize: '64px', fontWeight: 700, gap: '2px' }}>
          {data.username}

          <span style={{ color: 'rgba(153, 153, 153)', fontSize: '32px', fontWeight: 500 }}>
            #{data.discriminator}
          </span>
        </div>
