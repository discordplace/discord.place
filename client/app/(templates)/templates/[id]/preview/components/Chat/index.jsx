...
export default function Chat({ focusedChannel }) {
  return (
    <div className='pt-4 relative gap-y-6 flex w-full overflow-y-hidden h-[calc(100dvh_-_48px)] flex-1 bg-[#313338] flex-col'>
      <div className='flex px-4 gap-x-4'>
        <div className='w-[48px] h-[48px] rounded-full bg-[#3f4146]' />
        <div className='flex flex-col gap-y-2'>
          ...
          <div className='w-[150px] h-[200px] rounded-xl bg-[#3b3d43]' /> 
        </div>
      </div>
      ...
      <div className='flex px-4 gap-x-4'>
        ...
        <div className='flex flex-col gap-y-2'>
          ...
          <div className='w-[350px] h-[200px] rounded-xl bg-[#3b3d43]' />
        </div>
      </div>
      ...
      <div className='flex px-4 gap-x-4'>
        ...
        <div className='flex flex-col gap-y-2'>
          <div className='h-[20px] rounded-xl bg-[#4e5155] w-[80px]' />
          <div className='w-[150px] h-[250px] rounded-xl bg-[#3b3d43]' /> 
        </div>
      </div>
      ...
      <div className='px-4 bg-[#313338] w-full absolute bottom-0 pb-[24px]'>
        <div className='items-center flex w-full min-h-[44px] bg-[#383a40] rounded-lg'>
          <CirclePlusIcon className='w-6 h-6 ml-5 hover:text-[#dbdee1] cursor-pointer text-[#b5bac1]' />
        
          <div className='text-[#6d6f78] ml-4 flex flex-1 w-full select-none cursor-text'>
